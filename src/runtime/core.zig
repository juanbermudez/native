...
pub const WebViewNavigationPhase = runtime_api.WebViewNavigationPhase;
pub const WebViewNavigationFailureClass = runtime_api.WebViewNavigationFailureClass;
pub const WebViewNavigationEvent = runtime_api.WebViewNavigationEvent;
