...
// Retarget a live window without replacing its NSWindow identity.
// HUD windows preserve their current display and recompute their
// top-center safe-area anchor from the requested content size.
// transition: 0 = immediate, 1 = interruptible spring (reduce-motion
// always snaps).
