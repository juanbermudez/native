...
pub const AudioInputDevice = types.AudioInputDevice;
pub const AudioInputDeviceList = types.AudioInputDeviceList;
pub const AudioInputFormat = types.AudioInputFormat;
pub const AudioInputOptions = types.AudioInputOptions;
pub const AudioInputFrame = types.AudioInputFrame;
pub const AudioInputSink = types.AudioInputSink;
pub const AudioInputEvent = types.AudioInputEvent;
pub const AudioInputEventKind = types.AudioInputEventKind;
pub const max_audio_path_bytes = types.max_audio_path_bytes;
pub const max_audio_input_devices = types.max_audio_input_devices;
pub const max_audio_input_device_id_bytes = types.max_audio_input_device_id_bytes;
pub const max_audio_input_device_label_bytes = types.max_audio_input_device_label_bytes;
