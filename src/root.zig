...
pub const EffectAudioInput = runtime.EffectAudioInput;
...
pub const AudioInputDevice = platform.AudioInputDevice;
pub const AudioInputDeviceList = platform.AudioInputDeviceList;
pub const AudioInputFormat = platform.AudioInputFormat;
pub const AudioInputOptions = platform.AudioInputOptions;
pub const AudioInputFrame = platform.AudioInputFrame;
pub const AudioInputSink = platform.AudioInputSink;
pub const AudioInputEvent = platform.AudioInputEvent;
pub const AudioInputEventKind = platform.AudioInputEventKind;
pub const max_audio_input_devices = platform.max_audio_input_devices;
pub const max_audio_input_device_id_bytes = platform.max_audio_input_device_id_bytes;
pub const max_audio_input_device_label_bytes = platform.max_audio_input_device_label_bytes;
